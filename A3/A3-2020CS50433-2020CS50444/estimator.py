...
class Estimator(object):
    ...
    def __sens_model(self,sr,sc,e,posX,posY,sd):
        ...
        return p
    def __state_tran(self,sr,sc,tP,isParked,numRows,numCols): 
        flattr = tP[(sr,sc)]
    ...
    def estimate(self, posX: float, posY: float, observedDist: float, isParked: bool) -> None:
        ...
        # step 1,2
        for k in range(N):
            prcls[k] = self.__state_tran(prcls[k][0],prcls[k][1],tP,isParked,numRows,numCols)
